...
, transformacao as (
       select
        ...
        stg_cidade.cidade
    from stg_territorio
    left join stg_provincia on stg_territorio.pk_territorio = stg_provincia.fk_territorio
    left join stg_cidade on stg_provincia.pk_provincia = stg_cidade.fk_provincia
    left join stg_pais on stg_provincia.fk_code_regiao = stg_pais.pk_pais
)
select *
from transformacao